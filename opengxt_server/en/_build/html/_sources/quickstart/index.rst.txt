...
Getting started on GeoServer
=============================

After running the web browser, connect to GeoServer.

Admin section
--------------

GeoServer에 로그인하여 Welcome 페이지 오른쪽 상단의 Service GetCapabilities 목록을 확인합니다.
...
메뉴 페이지에서 [WPS] 메뉴를 클릭하여 Web Processing Service 페이지로 이동합니다.

이 섹션은 WPS 서비스의 활성화 여부, 서비스 메타데이터, 실행 설정 등의 환경을 설정할 수 있습니다.

.. image:: images/wps-page.png


아래로 스크롤 하면 다음의 [실행 설정] 탭이 보입니다.

[연결 유효시간]은 기본값이 120초이며 이는 프로세스 실행 후 연결이 종료되는 시간입니다.
...
[WPS Request Builder] 페이지의 [Select Process] 콤보박스에서 하나의 프로세스를 선택합니다.
